...
class Registro:
    ...
    def __init__(self,vetana):
        ...
        "--------------- Titulo --------------------"
        titulo= Label(ventana, text="REGISTRO DE USUARIO",bg="#6c757d",fg="black",font=("Comic Sans", 13,"bold"),pady=5).pack()
        ...
        self.combo_sexo=ttk.Combobox(marco,values=["Masculino", "Femenino"], width=12,state="readonly")
        ...
        self.combo_pregunta=ttk.Combobox(marco_pregunta,values=["¿Resides en esta comunidad?","¿Que tiempo tiene de residir en esta comunidad?"], width=30,state="readonly")
    ...
    def Ejecutar_consulta(self, query, parameters=()):
        with mysql.connect(self.db_name) as conexion:
